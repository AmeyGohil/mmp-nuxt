<template>
  <div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-lg-4">
            <div class="card mb-3">
                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" :src="avatar" width="160" height="160">
                ...
                <div class="col">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3"><label class="form-label" for="address"><strong>Contact Number</strong></label><input type="tel" id="address-1" placeholder="Sunset Blvd, 38" name="address"></div>
                            <div class="mb-3"><label class="form-label" for="address"><strong>Pin Code</strong></label><input type="text" id="address-2" placeholder="Sunset Blvd, 38" name="address"></div><button class="btn btn-primary btn-sm" type="submit">Save&nbsp;Settings</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
  ...
  data () {
    ...
    computed:{
        avatar(){
            return `${process.env.baseUrl}/assets/img/dogs/image2.jpeg`
        }
    }
}
</script>
