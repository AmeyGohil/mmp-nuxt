                    ...
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            <form @submit.prevent="saveUserSettings()">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="username"><strong>Name</strong></label><input v-model="userData.username" class="form-control" type="text" id="username" placeholder="Name" name="username"></div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="email"><strong>Email Address</strong></label><input v-model="userData.email" class="form-control" type="email" id="email" placeholder="Email" name="email"></div>
                                    </div>
                                </div>
                                <!-- <div class="row">
                                    <div class="col">
...
export default {
  ...
  async mounted(){
    //   console.log(this.$strapi.user)
      ...
      this.userData.mobile=this.$strapi.user.mobile
  },
  methods:{
